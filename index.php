    ...
    <section class="signup-form">
      ...
      <div class="form-design">
        ...
        <div class="form-child">
          ...
          />
          <h1 class="login-heading">Join Hertzsoft ChatApp Today</h1>
          <form class="main-form">
            <div class="input-fields">
              <div class="input-field">
                <input
                  class="input-field-box name-field"
                  type="text"
                  name="UserName"
                  placeholder="Name"
                  maxlength="100"
              ...
              <div class="input-field">
                <input
                  class="input-field-box email-field-signup"
                   name="UserMail"
                  type="email"
                  placeholder="Email "
                  required
              ...
              <div class="input-field">
                <input
                  class="input-field-box pass-field-signup"
                   name="UserPassword"
              ...
              <div class="input-field">
                <input
                  class="input-field-box dept-field"
                  type="text"
                  name="Role"
